...
const SettingsList = () => {
  ...
  return (
    <div className={styles["settings-container"]}>
        ...
        <ul className={styles["settings-list"]}>
          <li>
            ...
            <ul className={styles.profile}>
              ...
              <li>
                <button onClick={() => setActivePanel("delete")}>
                  Delete Account
                </button>
              </li>
              <li>
          ...
          <li>
            ...
            <ul className={styles.notifications}>
              <li>
                <button onClick={() => setActivePanel("push")}>
                  Push Notifications
                </button>
              </li>
            </ul>
      ...
      {activePanel === "profile" && (
        <ProfileInfo onClose={() => setActivePanel(null)} />
      )}
      {activePanel === "delete" && (
        <DeleteAccount onClose={() => setActivePanel(null)} />
      )}
      {activePanel === "export" && (
        <ExportData onClose={() => setActivePanel(null)} />
      )}
      {activePanel === "push" && (
        <PushNotifications onClose={() => setActivePanel(null)} />
      )}
      {activePanel === "gallery" && (
        <Gallery onClose={() => setActivePanel(null)} />
      )}
    </div>
  );
};
