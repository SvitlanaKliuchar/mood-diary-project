    ...
    useEffect(() => {
        ...
        try {
            ...
            const colorScale = d3.scaleOrdinal([
                "#544FBF", "#FF00F2", "#D72638", "#E2B7F5", "#B7C9F5",
                "#BAB7F5", "#605CDB", "#FFA07A", "#FFD700", "#5E6366"
    ...
    return (
        <div className={styles['word-count-container']} ref={containerRef}>
            ...
            <p className={styles['tips']}>
                We have processed the notes from all your entries and generated this word cloud. Word size represents frequency. Hover over words to highlight them.
            </p>
        </div>
    );
};
