...
describe('LoginForm Component', () => {
  ...
  test('renders the form with all elements', () => {
    ...
    const submitButton = screen.getByText('Sign in', { selector: 'button[type="submit"]' });
  ...
  test('button shows the correct text and is disabled during submission', () => {
    ...
    // Check initial state
    let submitButton = screen.getByText('Sign in', { selector: 'button[type="submit"]' });
    ...
    submitButton = screen.getByText('Signing in...', { selector: 'button[type="submit"]' });
