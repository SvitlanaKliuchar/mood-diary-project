...
describe("SignupForm Component", () => {
  ...
  test("renders the form with all elements", () => {
    ...
    expect(
      screen.getByText(/By signing up, you agree to our terms of use./i),
    ).toBeInTheDocument();
  ...
  test("navigates to terms of use page when link is clicked", () => {
    ...
    const termsLink = screen.getByText(
      /By signing up, you agree to our terms of use./i,
    );
  ...
  test("button shows the correct text and is disabled during submission", () => {
    ...
    // Check initial state
    let submitButton = screen.getByText("Sign up", {
      selector: 'button[type="submit"]',
    });
    ...
    submitButton = screen.getByText("Signing up...", {
      selector: 'button[type="submit"]',
    });
