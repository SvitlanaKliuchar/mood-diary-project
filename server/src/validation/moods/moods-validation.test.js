...
describe("Mood Validation", () => {
    it("should validate a correct mood payload", () => {
        const validPayload = {date: "2024-12-15", mood: "happy", note: "had a great date"}
    ...
    it("should reject a mood payload with an invalid date", () => {
        ...
        expect(() => createMoodSchema.parse(invalidPayload)).toThrow("Invalid date")
    })
    it("should reject a mood payload with an empty mood field", () => {
        const invalidPayload = { date: "2024-12-15", mood: ""}
        expect(() => createMoodSchema.parse(invalidPayload)).toThrow("Mood cannot be empty")
    })
    ...
    it("should reject a query with an invalid date format", () => {
        ...
        expect(() => getMoodsQuerySchema.parse(invalidQuery)).toThrow("Invalid date")
    })
})